...
::: {.docs-card}
### CBPSCategorical / CBPSContinuous

Use these when you want propensity scores whose inverse-probability weights balance covariate means by construction (ports of the R `CBPS` package).
:::
